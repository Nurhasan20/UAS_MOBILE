...
import com.example.baru2.NoteAdapter
...
//Setting button add
        ...
        buttonProfil.setOnClickListener {
            startActivity(
                Intent(this, biodataActivity::class.java)
            )
        }
...
//menghubungkan dengan adapter
        ...
        adapter.setOnItemClickListener(object : NoteAdapter.OnItemClickListener {
            override fun onItemClick(note: Note) {
                ...
                intent.putExtra(AddEditNoteActivity.EXTRA_CHECKIN, note.checkin)
                intent.putExtra(AddEditNoteActivity.EXTRA_CHECKOUT, note.checkout)
                intent.putExtra(AddEditNoteActivity.EXTRA_KAMAR, note.kamar)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == Activity.RESULT_OK) {
            val newNote = Note(
                ...
                data.getStringExtra(AddEditNoteActivity.EXTRA_CHECKIN),
                data.getStringExtra(AddEditNoteActivity.EXTRA_CHECKOUT),
                data.getStringExtra(AddEditNoteActivity.EXTRA_KAMAR),
